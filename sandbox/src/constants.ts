...
export const DEFAULT_SANDBOX_CREATE_TIMEOUT_MS = 120_000;
export const DEFAULT_SANDBOX_READY_TIMEOUT_MS = 60_000;
export const DEFAULT_SANDBOX_READY_POLL_INTERVAL_MS = 500;
export const DEFAULT_SANDBOX_WAIT_POLL_INTERVAL_MS = 100;
export const DEFAULT_SANDBOX_LONG_POLL_TIMEOUT_SECONDS = 60;
